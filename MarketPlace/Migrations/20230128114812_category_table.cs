...
public partial class category_table : Migration {
    protected override void Up(MigrationBuilder migrationBuilder) {
        migrationBuilder.AddColumn<int>(name: "CategoryId", table: "Sub_Category",
        ...
        migrationBuilder.CreateIndex(name: "IX_Sub_Category_CategoryId",
    ...
    protected override void Down(MigrationBuilder migrationBuilder) {
        ...
        migrationBuilder.DropIndex(name: "IX_Sub_Category_CategoryId",
                                   table: "Sub_Category");

        migrationBuilder.DropColumn(name: "CategoryId", table: "Sub_Category");
    }
}
}
