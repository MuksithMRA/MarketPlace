...
public class AutoMapperProfiles: Profile
{
    public AutoMapperProfiles()
    {
        ...
        CreateMap<Category, CategoryDTO>().ForMember(
            des => des.SubCategories,
            src => src.MapFrom(src => src.SubCategories)
        );
        //    .ForPath(
        ...
        CreateMap<Store, StoreDTO>().ForMember(
            des => des.Location,
            src => src.MapFrom(src => src.Location)
        ).ForMember(
            des => des.Products,
        ...
        CreateMap<Product, ProductDTO>().ForMember(
            des => des.Category,
            src => src.MapFrom(src => src.Category)
        ).ForPath(
            des => des.Category.SubCategories,
            src => src.MapFrom(src => src.Category.SubCategories)
        );
        //.ForPath(
        //    des => des.Category.SubCategories.Select((e) => e.Brand),
        //    src => src.MapFrom(src => src.Category.SubCategories.Select((e) => e.Brand))
        //).ForMember(
        //    des => des.Store,
