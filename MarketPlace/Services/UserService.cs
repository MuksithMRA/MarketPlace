...
public class UserService : IUserService {
  ...
  public Task<LoginResponse> Login(LoginRequest loginRequest) {
    ...
    if (_context.Users.Any(x => x.Email == loginRequest.Email)) {
      ...
      bool verified =
          BCrypt.Net.BCrypt.Verify(loginRequest.Password, userDto.Password);
  ...
  public Task<CommonResponse<RegisterRequestDto>>
  Register(RegisterRequestDto registerRequest) {
    CommonResponse<RegisterRequestDto> registerResponse =
        new CommonResponse<RegisterRequestDto>();
